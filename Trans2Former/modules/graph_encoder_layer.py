...
class Trans2FormerGraphEncoderLayer(nn.Module):
    def __init__(
        self,
    ...
    def forward(
        ...
        """
        LayerNorm is applied either before or after the self-attention/fnn
        ...
        return x, attn
        # # Graphormer Implementation of Attention Layers:
        # # Add, Norm 
        # residual = x
        # if self.pre_layernorm:
        #     x = self.self_attn_layer_norm(x)
